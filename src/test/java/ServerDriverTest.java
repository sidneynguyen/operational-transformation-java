...
public class ServerDriverTest {
    ...
    public void processChange1() throws Exception {
        ...
        op1.add(new OperationComponent(OperationComponent.OP_COMP_INSERT, "A", 1));
    ...
    public void processChange2() throws Exception {
        ...
        op2.add(new OperationComponent(OperationComponent.OP_COMP_INSERT, "B", 1));
    ...
    public void processChange3() throws Exception {
        ...
        op3.add(new OperationComponent(OperationComponent.OP_COMP_INSERT, "C", 1));
